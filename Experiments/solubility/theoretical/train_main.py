...
from Source.GCNN_FCNN.featurizers import featurize_sdf_with_solvent_united_no_split
...
featurize = partial(
    featurize_sdf_with_solvent_united_no_split,
...
trainer = GCNNTrainer(
    ...
    output_folder=str(ROOT_DIR / "Models" / "solubility" / "theoretical_descriptors" / args.experiment_name),
    epochs=args.epochs,
